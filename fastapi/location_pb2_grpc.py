...
class LocationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListLocations = channel.unary_unary(
                '/location.LocationService/ListLocations',
                request_serializer=location__pb2.EmptyRequest.SerializeToString,
                response_deserializer=location__pb2.LocationListResponse.FromString,
                _registered_method=True)
...
def add_LocationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListLocations': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=location__pb2.EmptyRequest.FromString,
                    response_serializer=location__pb2.LocationListResponse.SerializeToString,
            ),
    }
...
class LocationService(object):
    ...
    def ListLocations(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/location.LocationService/ListLocations',
            location__pb2.EmptyRequest.SerializeToString,
            location__pb2.LocationListResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
